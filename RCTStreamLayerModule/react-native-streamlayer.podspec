...
Pod::Spec.new do |s|
  ...
  s.header_dir     = 'react-native-streamlayer'
  ...
  s.pod_target_xcconfig = {
    ...
    'SWIFT_OBJC_INTERFACE_HEADER_NAME' => 'react-native-streamlayer-Swift.h',
    'SWIFT_VERSION' => '5.0',
    'OTHER_CFLAGS' => '$(inherited) -x objective-c++ -fmodules'
  }
  s.user_target_xcconfig = {
    "HEADER_SEARCH_PATHS" => [
      '"${PODS_CONFIGURATION_BUILD_DIR}/react-native-streamlayer/Swift Compatibility Header"',
      '"$(PODS_ROOT)/Headers/Private/Yoga"', # Expo.h -> react-native-streamlayer-umbrella.h -> Fabric ViewProps.h -> Private Yoga headers
    ],
  }
